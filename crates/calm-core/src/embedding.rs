...
mod imp {
    ...
    /// and exposed publicly so `calm-server`'s `bootstrap_embeddings` can
...
mod tests {
    ...
    /// exercises it.
    /// Run with: cargo test -p calm-core --release --features embeddings -- --ignored --nocapture bench_knn_latency
    #[cfg(feature = "embeddings")]
    #[test]
    #[ignore]
